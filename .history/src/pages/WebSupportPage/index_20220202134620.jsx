import gsap, { Linear, TimelineMax, TweenLite } from "gsap/all";
...
function calcOffset() {
  var center = document.querySelector(window).scrollTop + (window.innerHeight / 2) - (plane.height() / 2),
...
var planeTL1 = new TimelineMax()
  .add(TweenMax.to(plane, duration, {
    bezier: {
      values: arrayPath,
      type: "cubic",
      autoRotate: true
...
var scene = new ScrollMagic.Scene({
  ...
  .addEventListener("update", function (e) { 
    ...
    if (st === 'FORWARD') {
      plane.attr('src', 'http://static.indigoimages.ca/2016/shop/114450_img01_blueAirplane_45deg.png');
    } else if (st === 'REVERSE') {
      plane.attr('src', 'http://static.indigoimages.ca/114450_img01_blueAirplane_45deg__REVERSED.png');
    };
});
  });
  return (
