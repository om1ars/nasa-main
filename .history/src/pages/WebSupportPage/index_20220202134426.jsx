...
export default function WebSupportPage() {
  ...
  return (
    <div className="webSupport">
      ...
      <div>
        ...
        <div className="animated  bounce">
          <img src="http://static.indigoimages.ca/2016/shop/114450_img12_whiteAirplane_v3.png" alt="white plane" className="whitePlane" />
        </div>
        <div className="container" id="bezier">
          <img src="http://static.indigoimages.ca/2016/shop/114450_img01_blueAirplane_45deg.png" className="plane" id="plane" />
          <svg id="Layer_1" data-name="Layer 1" style={{enableBackground: 'new 0 0 940 3596.8'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 940 3596.8">
            <path style={{fill: 'none', isolation: 'isolate'}} />
            <path id="pathCubic" d="M-259.5,118.7c248.2,93.7,466.9,79.3,818.3,87.6c147.7,3.5,292.1,19.6,429.9,40.7s258.7,74.3,237.8,132
    ...
    c137.1,42.7,205.2,126.8,101.9,182.3c-83.4,44.8-365.8,105.6-498.2,124.8c-319.5,46.4-589.1,94.9-904,110.9" /></svg>
        </div>
      </div>
      </div>
    </div>
