...
export default function PortfolioFiltered() {
  ...
  return (
    <div>
      <section class="portfolioFiltered portfolio_section">
        <ul class="portfolio-cats">
          <li data-filter="*">All</li>
          <li data-filter="phone">Веб-сайт разработка</li>
          <li data-filter="laptop">Branding</li>
          <li data-filter="headphone">Design</li>
        </ul>
