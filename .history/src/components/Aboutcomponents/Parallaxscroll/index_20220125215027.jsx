    ...
    <div className="parallax">
      <div class="wrapper">
        <div class="header grid-container full">
          <div
            class="hero-banner bg-img grid-x"
        ...
        <div class="container">
          ...
          <div class="grid-container full">
            <div
              class="banner-wrapper bg-img"
              style="background-image:url('https://cdn.pixabay.com/photo/2015/03/26/18/36/spacex-693229_960_720.jpg');"
            >
              <div class="grid-container">
                <div class="grid-x grid-margin-x grid-margin-y">
        ...
        <div class="footer grid-container full">
          <div class="grid-x text-center">
            <p class="cell">
              <span class="copyright_date"></span> &copy; copyright{" "}
