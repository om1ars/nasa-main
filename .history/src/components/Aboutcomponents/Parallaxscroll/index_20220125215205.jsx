      ...
      <div className="wrapper">
        <div className="header grid-container full">
          <div
            ...
            style={{
              backgroundImage:
                'url("https://cdn.pixabay.com/photo/2016/08/10/02/10/world-1582347_960_720.jpg")',
            }}
          >
        ...
        <div className="container">
          <div className="grid-container full">
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://cdn.pixabay.com/photo/2019/05/31/16/16/australia-4242493_960_720.jpg")',
              }}
            >
              <div className="grid-container">
          ...
          <div className="grid-container full">
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://cdn.pixabay.com/photo/2019/09/06/10/36/astronaut-4456106_960_720.jpg")',
              }}
            >
              <div className="grid-container">
                <div className="grid-x grid-margin-x grid-margin-y">
        ...
        <div className="footer grid-container full">
          <div className="grid-x text-center">
            <p className="cell">
              <span className="copyright_date" /> © copyright{" "}
