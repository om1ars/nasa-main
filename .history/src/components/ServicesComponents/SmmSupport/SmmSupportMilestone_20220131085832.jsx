...
function SmmSupportMilestone() {
  ...
  return (
    <Section ref={element}>
      <div className="smmSupportMilestone_background">
        <img src={milestoneBackround} alt="Milestone Background" />
      </div>
      <div className="smmSupportMilestone_milestones">
        {milestone.map((ms) => {
          return (
            <motion.div
              className="smmSupportMilestone_milestone"
              key={ms.data}
...
const Section = styled.section`
  ...
  position: relative;
  overflow: hidden;
  .smmSupportMilestone_background {
    position: absolute;
    left: 0;
    bottom: -30%;
    img {
  ...
  .smmSupportMilestone_milestones {
    display: grid;
    grid-template-columns: repeat(3, 1fr);
    color: white;
    align-items: center;
    height: 100%;
    .smmSupportMilestone_milestone {
      z-index: 20;
      display: flex;
...
export default SmmSupportMilestone;
