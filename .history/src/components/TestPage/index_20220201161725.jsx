...
export default function TestPage() {
  useEffect(() => {
    ...
    ScrollTrigger.scrollerProxy(".testPage_container", {
      scrollTop(value) {
    ...
    ScrollTrigger.create({
      trigger: ".testPage_image-mask",
      scroller: ".testPage_container",
      start: "top+=30% 50%",
      end: "bottom-=40% 50%",
      animation: gsap.to(".testPage_image-mask", { backgroundSize: "120%" }),
      scrub: 2,
      // markers: true
    });
  ...
  return (
    <div className="testPage">
      <div data-scroll-container className="testPage_container">
        <div className="testPage_hero">
          <div data-scroll data-scroll-speed={3} className="testPage_copy">
            <blockquote>
          ...
          <div className="testPage_image-wrapper">
            <img
        ...
        <div className="testPage_section-0" data-scroll data-scroll-speed={2}>
          <p
            data-scroll
        ...
        <div className="testPage_section-1">
          <div className="testPage_image-mask" />
        </div>
        <div className="testPage_section-2">
          <div id="pinSection" className="testPage_pinned-quote">
            <blockquote
              data-scroll
              data-scroll-sticky
          ...
          <div className="testPage_images-container">
            <img
        ...
        <div className="testPage_section-3">
          <div className="testPage_image-wrapper">
            <img
