...
export default function TestPage() {
  useEffect(() => {
    THREE.SpriteMaterial = function (
      ...
      document.querySelector(canvas).css({
        width: frameWidth,
        height: frameHeight,
      });
    ...
    //set up render pass
    var renderScene = new THREE.Render(scene, camera);
    ...
    //
    var spikeyTexture = new THREE.TextureLoader().load(
    ...
    document.querySelector(document).mousemove(function (evt) {
