                ...
                <div className="o-layout_item u-2/5@from-medium">
                  <div className="c-section_infos" data-scroll>
                    ...
                    >
                      ...
                      <div className="c-sections_infos_text u-text">
                        <p>
                          Stagger those smooth animations using delays to create
                          a rushing or dragging effect.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="o-layout_item u-3/5@from-medium">
                      <div className="c-cta_section">
                        ...
                        >
                          ...
                          <p>
                            This library has evolved considerably over the
                            years. The architecture and conventions shift
                            according to our projects.
                          </p>
                          <p>
                            Visit the GitHub repository page for a complete
                            introduction and list of available options. Search
                            the GitHub issue tracker carefully to check if your
                        ...
                        >
                          <span className="o-button_icon">
                            <svg role="img">
                              <use xlinkHref="dist/images/sprite.svg#github" />
                            </svg>
                          </span>
                          Check on Github
                      ...
                      <div className="c-cta_section">
                        ...
                        >
                          ...
                          <p>
                            You like the font used on this page? Well this is
                            your lucky day. You can get it for free on{" "}
                            <a
